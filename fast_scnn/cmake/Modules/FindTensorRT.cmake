...
#
# Source: https://github.com/NVIDIA/tensorrt-laboratory/blob/master/tensorrt-laboratory/tensorrt/CMakeLists.txt
#
...
foreach(search ${_TensorRT_SEARCHES})
  find_path(NVINFER_INCLUDE_DIR NAMES NvInfer.h ${${search}} PATH_SUFFIXES include)
endforeach()
foreach(search ${_TensorRT_SEARCHES})
  find_path(NVONNXPARSER_INCLUDE_DIR NAMES NvOnnxParser.h ${${search}} PATH_SUFFIXES include)
endforeach()
set(TensorRT_INCLUDE_DIR ${NVINFER_INCLUDE_DIR} ${NVONNXPARSER_INCLUDE_DIR})

if(NOT TensorRT_LIBRARY)
  foreach(search ${_TensorRT_SEARCHES})
    find_library(NVINFER_LIBRARY NAMES nvinfer ${${search}} PATH_SUFFIXES lib)
  endforeach()
  foreach(search ${_TensorRT_SEARCHES})
    find_library(NVONNXPARSER_LIBRARY NAMES nvonnxparser ${${search}} PATH_SUFFIXES lib)
  endforeach()
  set(TensorRT_LIBRARY ${NVINFER_LIBRARY} ${NVONNXPARSER_LIBRARY})
endif()
